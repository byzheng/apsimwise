...
[apsimwise](https://apsimwise.bangyou.me/) is a collection of
interoperable R packages for crop modelling, weather analysis, and
...
This package installs and loads the core
[apsimwise](https://apsimwise.bangyou.me/) ecosystem, including:

- [tidyweather](https://tidyweather.bangyou.me/) for weather data
  analysis.
- [rapsimng](https://rapsimng.bangyou.me/) for manipulating APSIM Next
  Generation.
- Packages for specific crops, including:
  - [rapsimng.wheat](https://wheat.rapsimng.bangyou.me/) for
    [Wheat](https://notes.apsimng.bangyou.me/docs/Plants/Wheat/)
  - [rapsimng.canola](https://canola.rapsimng.bangyou.me/) for
    [Canola](https://notes.apsimng.bangyou.me/docs/Plants/Canola/)
  ...
  - [rapsimng.lupin](https://lupin.rapsimng.bangyou.me/) for
    [Lupin](https://notes.apsimng.bangyou.me/docs/Plants/Lupin/)
  - additional crop packages as they become available

## Get Started

[apsimwise](https://apsimwise.bangyou.me/) re-exports commonly used
functions from the ecosystem so that most users only need to load a
single package.
